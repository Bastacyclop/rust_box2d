...
impl DrawLink {
    pub fn new() -> DrawLink {
        unsafe {
            DrawLink {
                ptr: ffi::DrawLink_new(ffi::FatAny::null(),
                                       draw_polygon,
                                       draw_solid_polygon,
                                       draw_circle,
                                       draw_solid_circle,
    ...
    pub unsafe fn use_with(&mut self, object: &mut Draw, flags: DrawFlags) -> *mut ffi::Draw {
...
unsafe extern "C" fn draw_polygon(draw: ffi::FatAny,
                                  vertices: *const Vec2,
                                  count: i32,
                                  color: *const Color) {
...
unsafe extern "C" fn draw_solid_polygon(draw: ffi::FatAny,
                                        vertices: *const Vec2,
                                        count: i32,
                                        color: *const Color) {
    // color comes from a C++ &
...
unsafe extern "C" fn draw_circle(draw: ffi::FatAny,
                                 center: *const Vec2,
                                 radius: f32,
                                 color: *const Color) {
...
unsafe extern "C" fn draw_solid_circle(draw: ffi::FatAny,
                                       center: *const Vec2,
                                       radius: f32,
                                       axis: *const Vec2,
                                       color: *const Color) {
...
unsafe extern "C" fn draw_segment(draw: ffi::FatAny,
                                  p1: *const Vec2,
                                  p2: *const Vec2,
                                  color: *const Color) {
...
unsafe extern "C" fn draw_transform(draw: ffi::FatAny, xf: *const Transform) {
    // xf comes from a C++ &
    let draw = mem::transmute::<_, &mut Draw>(draw);
...
pub mod ffi {
    ...
    extern "C" {
        pub fn DrawLink_new(object: FatAny,
                            draw_polygon: unsafe extern "C" fn(FatAny,
                                                               *const Vec2,
                                                               i32,
                                                               *const Color)
                                                              ,
                            draw_solid_polygon: unsafe extern "C" fn(FatAny,
                                                                     *const Vec2,
                                                                     i32,
                                                                     *const Color)
                                                                    ,
                            draw_circle: unsafe extern "C" fn(FatAny,
                                                              *const Vec2,
                                                              f32,
                                                              *const Color)
                                                             ,
                            draw_solid_circle: unsafe extern "C" fn(FatAny,
                                                                    *const Vec2,
                                                                    f32,
                                                                    *const Vec2,
                                                                    *const Color)
                                                                   ,
                            draw_segment: unsafe extern "C" fn(FatAny,
                                                               *const Vec2,
                                                               *const Vec2,
                                                               *const Color)
                                                              ,
                            draw_transform: unsafe extern "C" fn(FatAny, *const Transform))
                            -> *mut DrawLink;
